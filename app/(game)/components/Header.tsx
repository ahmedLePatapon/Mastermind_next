    ...
    return (
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#242447] px-10 py-3">
            ...
            <div className="flex gap-4">
                ...
                <button
                    onClick={toggleTimer}
                    className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-[#242447] text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-3">
                    {isRunning ?
